...
revoke all on function api.get_group_by_invite_code(uuid) from anon, authenticated;
revoke all on function api.submit_group_rsvp(uuid, jsonb) from anon, authenticated;
revoke usage on schema api from anon, authenticated;
grant usage on schema api to service_role;
grant execute on function api.get_group_by_invite_code(uuid) to service_role;
grant execute on function api.submit_group_rsvp(uuid, jsonb) to service_role;
